...
def update_learning_rate(number_of_predictions, X, Y, begin, parameters, prev_cost, learning_rate):
    cost = 0
...
def L_layer_model(X, Y, layers_dims, learning_rate=1, num_epochs=5, batch_size=10, print_cost=False, file=None):
    ...
    for i in range(0, num_epochs):
        ...
        for j in range(0, num_batches):
            ...
            learning_rate = update_learning_rate(number_of_predictions, X, Y, begin - number_of_predictions, parameters,
                                                 cost, learning_rate)
        cost /= X.shape[1]
        if print_cost:
